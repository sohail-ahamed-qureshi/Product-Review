    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<ProductReview> list = new List<ProductReview>
            {
                ...
                new ProductReview(){ProductID = 3, UserID = 3, Rating =1, Review ="Good", isLike = false },
                new ProductReview(){ProductID = 4, UserID = 4, Rating =5, Review ="Good", isLike = true },
                new ProductReview(){ProductID = 5, UserID = 5, Rating =0, Review ="Good", isLike = false },
                ...
                new ProductReview(){ProductID = 8, UserID = 6, Rating =9, Review ="Good", isLike = true },
                new ProductReview(){ProductID = 9, UserID = 6, Rating =8, Review ="Good", isLike = true },
                new ProductReview(){ProductID = 10, UserID = 6, Rating =2, Review ="Good", isLike = false },
                new ProductReview(){ProductID = 11, UserID = 6, Rating =5, Review ="Good", isLike = true },
                new ProductReview(){ProductID = 12, UserID = 6, Rating =9, Review ="Good", isLike = true },
                new ProductReview(){ProductID = 13, UserID = 6, Rating =1, Review ="Good", isLike = false },
                new ProductReview(){ProductID = 14, UserID = 6, Rating =8, Review ="Good", isLike = true },
                new ProductReview(){ProductID = 15, UserID = 6, Rating =3, Review ="Good", isLike = true },
                ...
                new ProductReview(){ProductID = 18, UserID = 6, Rating =2, Review ="Good", isLike = false },
                new ProductReview(){ProductID = 19, UserID = 6, Rating =3, Review ="Good", isLike = true },
                new ProductReview(){ProductID = 20, UserID = 6, Rating =1, Review ="Good", isLike = false },
                new ProductReview(){ProductID = 21, UserID = 6, Rating =10, Review ="Good", isLike = true },
